 ...
 */
 ...
 const aboutImg = '../images/anayameet-logo.png';
 ...
 let recStartTime;
 let recElapsedTime;
 let anayameetTheme = 'dark'; // dark - grey ...
 let anayameetBtnsBar = 'vertical'; // vertical - horizontal
 let pinVideoPositionSelect;
 let swalBackground = 'rgb(91 18 149 / 70%)'; // black - #16171b - transparent ...
 let peerGeo;
 ...
 function getHtmlElementsById() {
     ...
     themeSelect = getId('anayameetTheme');
     videoObjFitSelect = getId('videoObjFitSelect');
     btnsBarSelect = getId('anayameetBtnsBar');
 ...
 async function whoAreYou() {
     ...
     Swal.fire({
         ...
         position: 'center',
         imageAlt: 'anayameet-name',
         imageUrl: enterNameImg,
 ...
 function welcomeUser() {
     ...
     Swal.fire({
         ...
         if (result.isConfirmed) {
             ...
             let message = {
                 email: '',
                 subject: 'Please join our anayameet Video Chat Meeting',
             ...
             switch (event.channel.label) {
                 case 'anayameet_chat_channel':
                     try {
                         ...
                         console.error('anayameet_chat_channel', err);
                     }
                     break;
                 case 'anayameet_file_sharing_channel':
                     try {
                         let dataFile = msg.data;
                         handleDataChannelFileSharing(dataFile);
                     } catch (err) {
                         console.error('anayameet_file_sharing_channel', err);
                     }
                     break;
             }
         };
                     ...
                     .then((local_description) => {
                         ...
                         peerConnections[peer_id]
                             ...
                             .then(() => {
                                 ...
                                 // https://github.com/miroslavpejic85/anayameet/issues/110
 ...
 /**
  * Set anayameet theme | dark | grey | ...
  * @param {string} theme type
  */
 function setTheme(theme) {
     if (!theme) return;
 
     anayameetTheme = theme;
     switch (anayameetTheme) {
         case 'dark':
             // dark theme
             swalBackground = 'radial-gradient(#3e0767, #46198f)';
             document.documentElement.style.setProperty('--body-bg', 'radial-gradient(#3e0767, #46198f)');
             document.documentElement.style.setProperty('--msger-bg', 'radial-gradient(#3e0767, #46198f)');
             document.documentElement.style.setProperty('--msger-private-bg', 'radial-gradient(#3e0767, #46198f)');
             document.documentElement.style.setProperty('--wb-bg', 'radial-gradient(#3e0767, #46198f)');
             ...
             document.body.style.background = 'radial-gradient(#3e0767, #46198f)';
             break;
         case 'grey':
             // grey theme
     ...
     setButtonsBarPosition(anayameetBtnsBar);
 }
 ...
 function setButtonsBarPosition(position) {
     ...
     anayameetBtnsBar = position;
     switch (anayameetBtnsBar) {
         case 'vertical':
 ...
 function createChatDataChannel(peer_id) {
     chatDataChannels[peer_id] = peerConnections[peer_id].createDataChannel('anayameet_chat_channel');
 ...
 function createFileSharingDataChannel(peer_id) {
     fileDataChannels[peer_id] = peerConnections[peer_id].createDataChannel('anayameet_file_sharing_channel');
 ...
 function selectFileToShare(peer_id, broadcast = false) {
     ...
     Swal.fire({
         allowOutsideClick: false,
         background: swalBackground,
         imageAlt: 'anayameet-file-sharing',
     ...
     if (isImageURL(incomingFileInfo.file.fileName)) {
         ...
         reader.onload = (e) => {
             Swal.fire({
                 ...
                 imageAlt: 'anayameet-file-img-download',
                 showDenyButton: true,
         ...
         Swal.fire({
             allowOutsideClick: false,
             background: swalBackground,
             imageAlt: 'anayameet-file-download',
             imageUrl: fileSharingImg,
             position: 'center',
             title: 'Received file',
             text: incomingFileInfo.file.fileName + ' size ' + bytesToSize(incomingFileInfo.file.fileSize),
 ...
 //         imageAlt: 'anayameet-about',
 //         imageUrl: aboutImg,
 //         html: `
 //         <br/>
 //         <div id="about">
 //             <b><a href="https://github.com/miroslavpejic85/anayameet" class="umami--click--github" target="_blank">Open Source</a></b> project
 //             <br/><br/>
 ...
 function leaveFeedback() {
     Swal.fire({
         ...
         text: 'Do you want to rate your anayameet experience?',
         confirmButtonText: `Yes`,
         denyButtonText: `No`,
         showClass: {
             popup: 'animate__animated animate__fadeInDown',
