...
const welcomeImg = '../images/person.png';
...
function setTheme(theme) {
    ...
    switch (mirotalkTheme) {
        case 'dark':
            ...
            document.documentElement.style.setProperty('--body-bg', 'radial-gradient(rgb(62, 7, 103), rgb(70, 25, 143))');
            document.documentElement.style.setProperty('--msger-bg', 'radial-gradient(rgb(62, 7, 103), rgb(70, 25, 143))');
...
function showAbout() {
    ...
    Swal.fire({
        ...
        <br/>
        <div id="about">
            <b><a href="https://github.com/miroslavpejic85/anyameet" class="umami--click--github" target="_blank">Open Source</a></b> project
            <br/><br/>
